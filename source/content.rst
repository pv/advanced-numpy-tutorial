...
.. only:: latex
   ...
   .. literalinclude:: ../data/mandel.pyx
...
.. literalinclude:: ../data/mandel-answer.pyx
   :language: python

.. literalinclude:: ../data/mandelplot.py
   :language: python
...
.. literalinclude:: ../data/pilbuffer-answer.py
   :language: python
...
* Breaking backwards binary compatibility, we need to clean up a bit 
  (Numpy 2.0, later)
...
* We should really have some public generalized ufuncs
  (e.g. multiplying many small matrices is often asked for)
